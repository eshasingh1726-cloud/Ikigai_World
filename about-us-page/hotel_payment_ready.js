...
(function(){
  ...
  // Payment function
  function initiatePayment(packageName, amount) {
    var options = {
      ...
      handler: function (response) {
        ...
        sendConfirmationEmail(packageName, amount, response.razorpay_payment_id);
      },
      prefill: {
        name: "", // You can optionally fetch user details
        email: "",
      },
      theme: {
        color: "#F37254"
  ...
  function sendConfirmationEmail(packageName, amount, paymentId) {
    emailjs.send("YOUR_SERVICE_ID", "YOUR_TEMPLATE_ID", {
      package_name: packageName,
      amount: amount,
      payment_id: paymentId,
      user_email: "user@example.com" // Replace or fetch dynamically
    })
...
function initiatePayment(hotelName, amount) {
  const options = {
    ...
    handler: function (response) {
      ...
      sendConfirmationEmail(hotelName, amount, response.razorpay_payment_id);
    },
    prefill: {
      name: "",
      email: ""
...
function sendConfirmationEmail(hotelName, amount, paymentId) {
  emailjs.send("YOUR_SERVICE_ID", "YOUR_TEMPLATE_ID", {
