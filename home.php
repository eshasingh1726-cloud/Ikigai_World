...
<body>
  ...
  <div class="video-background">
    <video autoplay loop id="bgVideo">
      <source src="images/
videoplayback (2).mp4" type="video/mp4">
    ...
    <div class="container">
      ...
      <div class="logo-container">
        <div class="logo-image">
          <a href = "home2.html"><img src="images/
New.png" alt="Ikigai World Logo"></a>
        </div>
   ...
   <div class="nav-actions">
    ...
    <a href="home2.html" class="nav-btn">Logout</a>
</div>
...
<div class="container trip-categories">
    ...
    <div class="row">
      ...
      <div class="col-md-4 mb-4">
        <div class="tool-box">
          ...
          <a href = "i1 copy.html"><button class="tool-button">Plan Your Trip</button></a>
        </div>
      </div>
  ...
  <!--Weather assistant-->
  <div class="weather-assistant-container">
    <div class="tool-box">
      <div class="tool-icon">
        <i class="fas fa-cloud"></i>
      </div>
      <h3 class="tool-title">Weather Assistant</h3>
      <p class="tool-description">
        Your weather daily companion-accurate, fast and easy to use.
      </p>
      <button class="tool-button">Ask Assistant</button>
    </div>
  </div>
</div>
...
<footer>
  ...
  <!-- Bootstrap JS -->
  <script src="images/
https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.3.0/js/bootstrap.bundle.min.js"></script>
...
<div id="chatbotModal" class="chatbot-modal">
  <div class="chatbot-wrapper">
    <iframe src="images/
chatbot.html" frameborder="0" width="100%" height="100%"></iframe>
